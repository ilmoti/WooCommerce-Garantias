...
class WC_Garantias_Customer {
   public static function init() {
    ...
    add_action( 'init', [ __CLASS__, 'add_cupones_endpoint' ] );
    ...
    add_action( 'woocommerce_account_cupones-garantia_endpoint', [ __CLASS__, 'contenido_cupones_cliente' ] );
}
    ...
    public static function add_cupones_endpoint() {
        add_rewrite_endpoint( 'cupones-garantia', EP_ROOT | EP_PAGES );
    }
    ...
    public static function contenido_cupones_cliente() {
    include WC_GARANTIAS_PATH . 'templates/myaccount-cupones.php';
}
}
